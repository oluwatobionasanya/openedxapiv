...
"""
openedxapiv documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedxapiv',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/openedxapiv",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedxapiv'),
                os.path.join(root_path, 'openedxapiv/migrations')])
